...
@interface AddDeviceStep2AP : UIViewController<ParametersConfigDelegate,UITableViewDelegate,UITableViewDataSource>
{
...
@property (retain, nonatomic) ParametersConfig* parametersConfigStep2AP;
@end
