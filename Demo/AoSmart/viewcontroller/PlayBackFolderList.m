...
- (void)viewDidLoad {
    ...
    _parametersConfigFolderList=[[ParametersConfig alloc]init:self ip:deviceConnectingIp password:deviceConnectingpsk];
    [_parametersConfigFolderList getVideoFolderList];
}
